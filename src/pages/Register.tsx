...
const Register = () => {
  ...
  const [passwordCheckValue, setPasswordCheckValue] = useInput();
  const [nameValue, setNameValue] = useInput();
  const [jobValue, setJobValue] = useInput();
  const [descValue, setDescValue] = useInput();
      ...
      <StBackground>
        <StContainer>
          ...
          ? (<>
              ...
              <StInput type="text" onKeyDown={(e) => onEnterKeyDownEmail(e)} ref={emailInputRef} id="email" value={emailValue} onChange={(e) => {setEmailValue(e.target.value); clearWarningMessage(); setIsEmailInput(true); setAllowEmailMessage(false); setDuplicateEmailValidation(false);}} placeholder="Email"/>
              <StValidationTextDiv>
              ...
              <StInput type="password" onKeyDown={(e) => onEnterKeyDownPassword(e)} ref={passwordInputRef} id="password" value={passwordValue} onChange={(e) => {setPasswordValue(e.target.value); clearWarningMessage(); setIsPwWriten(true);}} placeholder="Password"/>
              ...
              <StInput type="password" onKeyDown={(e) => onEnterKeyDownPasswordCheck(e)} ref={passwordCheckInputRef} id="passwordCheck" value={passwordCheckValue} onChange={(e) => {setPasswordCheckValue(e.target.value); clearWarningMessage();}} placeholder="Password Check"/>
              <StValidationTextDiv>
